...
const RangeSlider = dynamic(() => import('@/components/Chart/RangeSlider'), {
  ssr: false
})
...
const Chart: FC<Props> = ({ initial, indicator, country }) => {
  const data = useGetChartData(indicator.id, country)
    ...
    return (
      <>
        <div className='container mb-2 md:mb-3.5'>
          <div
            className='px-2 pr-3 pt-4 pb-4 md:pt-6 md:px-7 md:pb-3 rounded-lg bg-white border relative'
            id='chart'
          >
